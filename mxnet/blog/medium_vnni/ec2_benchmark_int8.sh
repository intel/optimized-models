...
echo "Testing INT8 quantized models"
...
echo "Testing with MXNET_SUBGRAPH_BACKEND="$MXNET_SUBGRAPH_BACKEND
...
echo "4. testing throughput of int8 resnet50_v1"
...
echo "5. testing latency of int8 resnet50_v1"
# python imagenet_inference.py --symbol-file=./model/resnet50_v1-quantized-5batches-naive-symbol.json --batch-size=1 --num-inference-batches=500 --ctx=cpu --benchmark=True
echo "=============resnet101_v1==============="
...
echo "4. testing throughput of int8 resnet101_v1"
...
echo "5. testing latency of int8 resnet101_v1"
# python imagenet_inference.py --symbol-file=./model/resnet101_v1-quantized-5batches-naive-symbol.json --batch-size=1 --num-inference-batches=500 --ctx=cpu --benchmark=True
echo "=============mobilenet1.0==============="
...
echo "4. testing throughput of int8 mobilenet1.0"
...
echo "5. testing latency of int8 mobilenet1.0"
# python imagenet_inference.py --symbol-file=./model/mobilenet1.0-quantized-5batches-naive-symbol.json --batch-size=1 --num-inference-batches=500 --ctx=cpu --benchmark=True
echo "=============inceptionv3==============="
...
echo "4. testing throughput of int8 inceptionv3"
...
echo "5. testing latency of int8 inceptionv3"
# python imagenet_inference.py --symbol-file=./model/inceptionv3-quantized-5batches-naive-symbol.json --image-shape=3,299,299 --batch-size=1 --num-inference-batches=500 --ctx=cpu --benchmark=True
...
# cd ..
echo "2. quantizing model"
# python quantization.py
echo "3. testing throughput of fp32 SSD VGG16"
# python benchmark_score.py --batch_size=224 --deploy --prefix=./model/ssd_
echo "4. testing throughput of int8 SSD VGG16"
# python benchmark_score.py --batch_size=224 --deploy --prefix=./model/cqssd_
echo "5. testing latency of fp32 SSD VGG16"
# python benchmark_score.py --batch_size=1 --deploy --prefix=./model/ssd_
echo "6. testing latency of int8 SSD VGG16"
# python benchmark_score.py --batch_size=1 --deploy --prefix=./model/cqssd_
