...
def GetArgumentParser():
    ...
    parser.add_argument(
        "-quant", "--quantize_input",
        action='store_true',
        help="Use the int8 model and use quantized input."
    )
    parser.add_argument(
        "-quant_once", "--quantize_input_once",
        action='store_true',
        help="Use the int8 model and use quantized input with dummy data"
    )
    parser.add_argument(
        "-onnx", "--onnx_model",
        action='store_true',
